...
execute_process(
  COMMAND "/opt/homebrew/bin/git" show-ref "main"
  WORKING_DIRECTORY "/Users/camiel-private/Documents/GitHub/zlib-minimal-test/cmake-build-debug/_deps/zlib-minimal-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/camiel-private/Documents/GitHub/zlib-minimal-test/cmake-build-debug/_deps/zlib-minimal-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/camiel-private/Documents/GitHub/zlib-minimal-test/cmake-build-debug/_deps/zlib-minimal-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
